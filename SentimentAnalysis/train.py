...
from utils import make_current_datetime_dir, compute_metrics, preprocess_data
...
if __name__ == '__main__':
    opt = {'pretrained_model': 'beomi/KcELECTRA-base-v2022',
           ...
           'train_dataset_path': './data/preprocess/감성대화말뭉치_train.csv', #train data
           'val_dataset_path': './data/preprocess/감성대화말뭉치_val.csv', # val data
           'output_dir': 'weights/',
